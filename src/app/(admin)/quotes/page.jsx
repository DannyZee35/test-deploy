                ...
                <tbody>
                    {currentEntries.map((client, index) => (
                        ...
                        >
                            ...
                            <td className="px-6 py-4">{client.supplier}</td>
                            <td className="px-6 py-4">{client.rawMaterial}</td>
                            <td className="px-6 py-4">{client.composition}</td>
                            <td className="px-6 py-4">{client.requestDate}</td>
...
const clientData = Array.from({ length: 100 }, (_, i) => ({
    id: `3479${i + 1}`,
    supplier: i % 2 === 0 ? 'Ammar Hussain' : 'John Doe',
    rawMaterial: i % 2 === 0 ? 'Pre-Forms, Caps,Labels' : 'Cable, Wire, Hammer',
    composition: i % 2 === 0 ? '330ml' : '220ml',
...
const QuotesPage = () => {
    return (
        <div className='px-7 py-5'>
            <TopBar title={'All Orders'} button={'Create Quote'}/>
