        ...
        <div className="flex justify-center py-10">
            <div className="w-full bg-white rounded-lg shadow-md p-8">
                <div className="mb-6">
                    <div className="">
                        <div>
                            <h1 className="text-2xl font-bold">Quote ID</h1>
                            <p className="text-green-800 font-medium">#7894590</p>
                        </div>
                        <div className="mt-5 flex gap-32">
                            <p className="font-medium">
                                <b>Status: </b><span className="text-green-500">Accepted</span>
                            </p>
                            <p className="text-sm text-gray-600"><b>Requested on:</b> 23 April, 2024</p>
                        </div>
                    </div>
                </div>
