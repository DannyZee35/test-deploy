                    ...
                    <div className="">
                        <table className="border rounded-lg w-1/2 text-left">
                            <thead className="bg-gray-100">
                                <tr>
                                    <th className="px-4 py-2 text-sm font-medium text-gray-600">Composition</th>
                                    <th className="px-4 py-2 text-sm font-medium text-gray-600">Boxes</th>
                                    <th className="px-4 py-2 text-sm font-medium text-gray-600">Status</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr className="border-t">
                                    <td className="px-4 py-2 text-gray-700">330ml</td>
                                    <td className="px-4 py-2 text-gray-700">70</td>
                                    <td className="px-6 py-4">
                                        <span
                                            className={`inline-block px-3 py-1 rounded-full text-sm font-medium text-green-600 bg-green-100`}
                                        >
                                            Pass
                                        </span>
                                    </td>
